            ...
            >
              <thead>
                <tr>
                  ...
                  <th>No. Plat</th>
                  <th>Jenis</th>
                  <th>Kapasitas Maks (Kg)</th>
                  @can('admin') <th>Perusahaan</th> @endcan
                  <th>Aksi</th>
                </tr>
              </thead>
              <tbody></tbody>
  ...
  <script>
    $('#myTable').DataTable({
      ...
      columns: [
        ...
        { data: 'type' },
        { data: 'max_capacity' },
        @can('admin') { data: 'company.name' }, @endcan
        {
          data: null,
          render: (data) => `
            <a href="/vehicles/${ data.id }/edit" class="btn btn-warning">
